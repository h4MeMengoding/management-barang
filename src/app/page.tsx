      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8 flex flex-wrap gap-3">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 sm:px-6 py-3 sm:py-4 dark-button text-orange-400 font-medium hover:text-orange-300 transition-all duration-200 text-sm sm:text-base"
          >
