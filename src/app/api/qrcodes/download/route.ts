  ...
  try {
    ...
    if (typeof window === 'undefined') {
      try {
        ...
        // Try multiple possible paths for font file in priority order
        const customFontPaths = [
          // Development paths
          path.join(process.cwd(), 'public', 'fonts', 'Roboto-ExtraBold.ttf'),
          path.resolve('./public/fonts/Roboto-ExtraBold.ttf'),
          path.resolve(process.cwd(), './public/fonts/Roboto-ExtraBold.ttf'),
          ...
          path.join(process.cwd(), 'dist', 'public', 'fonts', 'Roboto-ExtraBold.ttf'),
        ];
