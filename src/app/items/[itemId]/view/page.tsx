          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Informasi detail barang (tampilan baca saja)
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="dark-card qr-card-stroke p-6">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
                <div className="flex items-center space-x-2">
                  <span className="bg-green-600/20 text-green-300 px-4 py-2 rounded-lg text-sm border border-green-600/30 font-medium">
                    {item.category}
                  </span>
                </div>
              </div>
            ...
            <div className="dark-card qr-card-stroke p-6">
              ...
              {item.lockerId ? (
                <div className="space-y-4">
                  {/* QR Code */}
                  {item.lockerId.qrCode && (
                    <div className="text-center mb-4">
                      <div className="inline-block bg-white p-3 rounded-lg">
                        <Image 
                          src={item.lockerId.qrCode} 
                          alt="QR Code Loker"
                          width={120}
                          height={120}
                          className="rounded"
                ...
                <div className="text-center py-8">
                  <div className="dark-icon inline-flex mb-4 p-4">
                  ...
                  <p className="text-gray-500 text-sm">
                    Barang ini belum ditempatkan di loker manapun
                  </p>
                </div>
              )}
            </div>
