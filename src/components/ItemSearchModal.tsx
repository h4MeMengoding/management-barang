...
import { Search, X, Package, MapPin, Edit2, Eye } from 'lucide-react';
...
interface ItemSearchModalProps {
  ...
  searchResults: Item[];
  isSearching: boolean;
  getLockerInfo: (lockerId: string | { _id: string; code: string; label: string }) => Locker | { _id: string; code: string; label: string } | undefined;
}
